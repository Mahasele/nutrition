...
export default function NewClient() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setStatus('')
    const data = {username,email,name,phone,age,height,weight,dietaryRestrictions,password,gender,goal,address}
    try{
  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        <Container maxWidth="lg" style={{ margin: '20px 0', padding:'5px' }}>
          <Paper style={{ padding: '20px' }}>
            <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>Create Client</h2>
